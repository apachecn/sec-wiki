...
> 原文：[https://www.zhihuifly.com/t/topic/3529](https://www.zhihuifly.com/t/topic/3529)
...
(or) drop table black
     ...
     select top 1 mulu from black where id=1 `xp_cmdshell被删除时，可以用(4.a)开启沙盒模式，然后(4.b)方法提权` 
```
