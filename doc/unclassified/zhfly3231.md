...
> 原文：[https://www.zhihuifly.com/t/topic/3231](https://www.zhihuifly.com/t/topic/3231)
...
![image](img/9f8c6e02036489581b59018bb31a36c9.png)

### 2.重写PersistenContext类

因为需要用到 PersinstenContext 这个类，因此序列化的时候肯定要将其实例化，但是在下图代码位置有个if检查。

![image](img/7077f169f44a98d3898a317a0bcfe3f0.png)

在这个if检查的结果会抛出 com.bea.core.security.managers.NotSupportedException 的异常导致反序列化中止。

![image](img/c01d1a5431426208c986592efebb3bba.png)

因此这里解决办法就是绕过它，把它注释掉。

![image](img/db75397bc86a25f0c65869aa6f8b8d3f.png)

### 3.改造writeSubject中的writeObject

原先在 writeSubject 中正常写入的对象如下图所示。

![image](img/6f3295f212b88d9ec674656fc7e7932a.png)

这里我们需要将其替换掉，改成我们自己恶意对象，我的做法是构造恶意的JRMP对象。

![image](img/6392b3ef90591990b08571caad886340.png)
...
![image](img/92550fd77a5bb807789e9f7e121b4112.png)
...
![image](img/5104f7fcf160e7dee862d145bdcd0d5f.png)

所以我重写了一个 EncryptionUtil ，并且将 getEncryptionService 设置为了 public 。

![image](img/9a45544a493b003fb7cd84357e2561da.png)

![image](img/c74466365311b69745a8ac60f43c827f.png)
...
![image](img/437d7f0e7dfd7b3dd9db5764257cf0bc.png)
...
![image](img/7f883c99b61c7ce012c2ec959dc35980.png)

![image](img/2643edc75f7b6a1085f145da91b6b6d9.png)
